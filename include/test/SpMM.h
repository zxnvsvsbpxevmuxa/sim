...
#include <tmatrix/Calculation/TileMatrix_x_m.h>

void test_SpMM(const char *filepath)
{
    MatIndex m, n, nnz;
    ...
    echo(title, "test SpMM on %s", filepath);
    ...
    echo(start_status, "Simulate SpMM@128MAC");
    task_results t32 = TileMatrix_SPMM_Num_Sim<128>(seqtile, 64);
    echo(start_status, "Simulate SpMM@64MAC");
    task_results t64 = TileMatrix_SPMM_Num_Sim<64>(seqtile, 64);
    echo(stop_status, "");
